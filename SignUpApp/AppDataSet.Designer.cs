...
namespace SignUpApp {
    ...
    public partial class AppDataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsersRow AddUsersRow(string UserName, string Password, string FullName, string Email, string Address) {
...
namespace SignUpApp.AppDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Users] ([UserName], [Password], [FullName], [Email], [Address]" +
                ") VALUES (@UserName, @Password, @FullName, @Email, @Address);\r\nSELECT UserName, " +
                "Password, FullName, Email, Address FROM Users WHERE (UserName = @UserName)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [UserName] = @UserName, [Password] = @Password, [FullName] = @FullName, [Email] = @Email, [Address] = @Address WHERE (([UserName] = @Original_UserName) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ((@IsNull_FullName = 1 AND [FullName] IS NULL) OR ([FullName] = @Original_FullName)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)));
SELECT UserName, Password, FullName, Email, Address FROM Users WHERE (UserName = @UserName)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SignUpApp.Properties.Settings.Default.DatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UserName, Password, FullName, Email, Address FROM dbo.Users";
        ...
        public virtual int Delete(string Original_UserName, string Original_Password, string Original_FullName, string Original_Email, string Original_Address) {
        ...
        public virtual int Insert(string UserName, string Password, string FullName, string Email, string Address) {
            if ((UserName == null)) {
        ...
        public virtual int Update(string UserName, string Password, string FullName, string Email, string Address, string Original_UserName, string Original_Password, string Original_FullName, string Original_Email, string Original_Address) {
            if ((UserName == null)) {
                throw new global::System.ArgumentNullException("UserName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Password, string FullName, string Email, string Address, string Original_UserName, string Original_Password, string Original_FullName, string Original_Email, string Original_Address) {
            return this.Update(Original_UserName, Password, FullName, Email, Address, Original_UserName, Original_Password, Original_FullName, Original_Email, Original_Address);
        }
    }
